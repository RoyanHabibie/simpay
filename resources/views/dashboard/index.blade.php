...
@section('content')
                                ...
                                <ul class="list-group list-group-flush small">
                                    ...
                                    @if (Auth::user()->role === 'pusat')
                                        <li class="list-group-item">Total Nilai (Modal):
                                            <strong>Rp
                                                {{ number_format((float) $data['total_nilai'], 0, ',', '.') }}</strong>
                                        </li>
                                    @endif
    ...
    <div class="row">
        @foreach ($tren as $nama => $t)
            @if (Auth::user()->role === 'pusat' || Auth::user()->role === $nama)
    ...
    <div class="row mt-3">
        @foreach (['pusat', 'jeret', 'jt', 'ruko'] as $cab)
            @if (Auth::user()->role === 'pusat' || Auth::user()->role === $cab)
                <div class="col-md-3">
                    <div class="card mb-3">
